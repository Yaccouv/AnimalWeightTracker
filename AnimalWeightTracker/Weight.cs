...
namespace AnimalWeightTracker
{
    class Weight: Measurement
    {
        ...
        public bool AddweightORwaist(string animalName, ComboBox cmbMeasuretype, string measure, ComboBox cmbTime, DateTime date)
        {
            ...
            date = DateTime.Now;
            string query = "insert into Measurement Values('" + aMeasure + "','" + aType + "','" + aAnimalID + "','" + Time + "','" + adate + "')";
        ...
        {
            SetweightORwaist(animalName, cmbMeasuretype, measure, cmbTime, adate);
        ...
        {
            string query = "delete from Measurement where MeasurementID='" + MeasurementID + "'";
            database.Manipulate(query);
        ...
        public void AverageWeight(string animalname, string date)
        {
            Label average = Application.OpenForms["ManageAnimals"].Controls["tabControl1"].Controls["tabPage4"].Controls["lblWeight"] as Label;
            string type = "Weight";
            double morning = 0;
            double evening = 0;
        ...
        public void CalculationofAverageWeightLossORGain(string animalname, string date)
        {
